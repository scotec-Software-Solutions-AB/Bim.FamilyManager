...
/// </summary>
/// <remarks>
///     This class extends <see cref="FolderViewModel{FamilyExplorerLayoutOptions}" /> and customizes the creation of
///     subfolder
...
public class FolderViewModel : FolderViewModel<FamilyExplorerLayoutOptions>
{
    ...
    public FolderViewModel(
        ...
        ILogger<FolderViewModel<FamilyExplorerLayoutOptions>> logger)
