...
/// <summary>
/// Represents a Revit family, providing access to its metadata, symbols, preview image, and operations for initialization, saving, and updating.
...
public sealed class RevitFamily : IRevitFamily
{
    ...
    /// </summary>
    /// <value>
    /// A <see cref="Stream"/> containing the preview image of the Revit family, or <c>null</c> if no preview is available.
    /// </value>
    /// <remarks>
    ...
    /// <summary>
    /// Applies an update to the Revit family by replacing its current information with the provided <paramref name="familyInfo"/>.
    /// </summary>
    ...
    /// <remarks>
    /// This property retrieves the product version information from the underlying <see cref="RevitFamilyInfo"/> instance.
    /// </remarks>
