...
/// <summary>
/// View model for a family source in the Revit Family Manager, providing access to its folders, preview image, and selection state.
/// </summary>
/// <remarks>
/// This class manages the interaction with a family source, including its folders and preview image, and supports UI binding.
/// </remarks>
public class FamilySourceViewModel : FamilySourceViewModel<ModernLayoutOptions>
{
    ...
    /// <returns>A new <see cref="FamilySourceViewModel"/> instance configured with the specified <paramref name="familySource"/>.</returns>
