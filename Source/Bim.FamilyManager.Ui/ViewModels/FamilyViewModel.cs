...
/// <remarks>
/// Encapsulates a <see cref="IRevitFamily"/> instance and exposes properties and commands for interacting with family details, such as its name, preview image, and symbols.
/// </remarks>
    ...
    where TLayoutOptions : LayoutOptions
{
        ...
        : base(layoutOptions)
    {
        ...
        Family = family;
        family.Initialized += (sender, args) =>
        {
        ...
        family.LoadedInDocumentChanged += (sender, args) =>
        {
