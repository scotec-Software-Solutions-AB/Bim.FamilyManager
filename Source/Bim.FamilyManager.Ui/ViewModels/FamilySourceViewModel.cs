    ...
    where TLayoutOptions : LayoutOptions
{
    ...
    /// </summary>
    /// <param name="familySource">An instance of <see cref="IFamilySource"/> representing the family source to be managed by this view model.</param>
    /// <param name="panelFactory">A factory delegate for creating instances of <see cref="IFamilySourcePanelViewModel"/> to represent the panel for the family source.</param>
    /// <param name="layoutOptions">An <see cref="IOptionsMonitor{TLayoutOptions}"/> providing the current and updated layout options.</param>
    /// <remarks>
    /// This constructor sets up the view model with the specified family source and panel factory, enabling interaction with the family source's data and its associated panel.
    /// </remarks>
    ...
    /// </summary>
    /// <value>
    /// The selected folder represented by an <see cref="IFolderViewModel"/> instance, or <c>null</c> if no folder is selected.
    /// </value>
    /// <remarks>
