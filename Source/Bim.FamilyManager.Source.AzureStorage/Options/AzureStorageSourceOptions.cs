...
public class AzureStorageSourceOptions : FamilySourceOptions
{
    ...
    /// <summary>
    ///     Gets or sets the virtual folder path within the container. This is optional and can be used to scope the source to a subfolder.
    /// </summary>
    public string RootPath { get; set; } = string.Empty;
    
    /// <summary>
    ///     Gets or sets the user name associated with the Azure storage source. This is optional and may be used for display or auditing purposes.
    /// </summary>
